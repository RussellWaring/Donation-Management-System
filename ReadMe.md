...
We tied this together by creating a WPF desktop application using Visual Studio Enterprise. The project featured live queries and CRUD functionality, user data, and data visualizations which were programmatically generated.
